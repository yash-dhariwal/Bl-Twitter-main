...
const TweetCard = ({ tweet }: Props) => {
  const { content, createdAt, createdBy, id } = tweet;
  ...
  return (
    <div className="flex hover:shadow transition-all ease-in-out group duration-200 flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-gray-900 text-gray-100">
      ...
      <div className="flex-1">
        ...
        <Link
          to={`/post/${id}`}
          className="mb-1 text-xl hover:underline gorup-hover:shadow-oxford_blue-700 font-semibold line-clamp-2"
        >
          {content}
        </Link>
        <p className="text-sm text-gray-400">
          {"#comedy, #technology, #memes"}
        </p>
      </div>
